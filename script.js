...
const play = () => {
    ...
    if (userGuess != answer) {
        ...
        hint.innerHTML = `Congratulations! <br/> The Number was <span>${answer}</span>. <br/> You guessed it in <span>${noOfGuesses}</span> tries.`;
...
document.getElementById("check-btn").addEventListener("click", play);
